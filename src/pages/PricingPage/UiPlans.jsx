  ...
  return (
    <div>
      <section className="w-full h-[1600px] flex justify-center items-center bg-[#021314]">
        <div className="w-[1325px] h-[1501px] flex flex-col justify-start items-center gap-[116px]">
          <div className="w-[1018px] h-[414px] flex flex-col justify-start items-center gap-[61px]">
            ...
            <div className="w-[355px] h-[74px] rounded-[40px] px-[28px] py-[20px] text-[white] shadow-inner-[-3px_4px_4px_0] shadow-inner-[#00000040] flex flex-row-reverse justify-center items-center bg-[#FFFFFF33] font-semibold text-[24px]">
              Yearly
              <div className="w-[188px] h-[74px] rounded-[40px] p-[20px] flex justify-center items-center bg-gradient-to-t from-[#007B82] to-[#00B0BA] text-white font-semibold text-[24px] text-center leading-[140%] relative left-[-49px]">
                Monthly
              </div>
            </div>
          </div>
