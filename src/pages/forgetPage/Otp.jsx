                  ...
                  <div className='w-[525px] min-h-[444px] rounded-[10px] border-[1px] border-solid border-white px-[32px] py-[28px] shadow-sm shadow-black flex flex-col justify-center items-center gap-[40px] bg-[#00000033] backdrop-blur-sm'>
                      ...
                      <div className='w-[461px] min-h-[320px] flex flex-col justify-center items-center gap-[40px]'>
                          <div className='w-[100%] min-h-[86px] flex flex-col justify-center items-center gap-[12px]'>
                              <div className='w-[289px] min-h-[26px] font-semibold text-[26px] leading-[26px] text-center text-[#009A98]'>Enter OTP</div>
                              <div className='w-[461px] min-h-[48px] font-[400] text-[15px] leading-[24px] text-center text-[#B0B0B0] '>We’ve sent a 6-digit OTP to your email. Please enter it below to continue.</div>
                          ...
                          <div className='w-[461px] min-h-[260px] flex flex-col gap-[40px]'>
                            ...
                            <div className='w-[461px] min-h-[200px] flex flex-col gap-[40px]'>
                                ...
                                <a href="/ResetPassword"> <div className='w-[461px] min-h-[46px] rounded-[8px] bg-gradient-to-l from-[#00B0BA] via-[black] to-[#007B82] flex justify-center items-center text-[white] font-bold text-[16px] leading-[35px] text-center cursor-pointer'>Verify OTP</div></a>

                                <div className='w-[461px] min-h-[24px] font-[400] text-[13px] leading-[24px] text-center text-white'>Didn’t receive the code?<span className='text-[#007B82]'> Resend in 00:45</span></div>

                                 <div className='w-[461px] text-center flex justify-center'>
                                                          <a href="" className='w-[122px] h-[20px] flex justify-center items-center gap-[4px]'> <img src={Arrow} alt="" />
