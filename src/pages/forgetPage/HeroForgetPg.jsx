            ...
            <div className='w-[525px] min-h-[444px] rounded-[10px] border-[1px] border-solid border-white px-[32px] py-[28px] shadow-sm shadow-black flex flex-col justify-center items-center gap-[0px] bg-[#00000033] backdrop-blur-sm'>
                ...
                <div className='w-[461px] min-h-[320px] flex flex-col justify-center items-center gap-[40px]'>
                    <div className='w-[100%] min-h-[86px] flex flex-col justify-center items-center gap-[12px]'>
                        <div className='w-[289px] min-h-[26px] font-semibold text-[26px] leading-[26px] text-center text-[#009A98]'>Forgot your password?</div>
                        <div className='w-[461px] min-h-[48px] font-[400] text-[15px] leading-[24px] text-center text-[#B0B0B0] '>No worries. Enter your email and we’ll send you a one-time password (OTP) to reset it.</div>

                    </div>

                    <div className='w-[461px] min-h-[194px] flex flex-col justify-center items-center gap-[40px]'>
                        <input type="text" placeholder='ramprakash@example.com' 
...
<a href="/Otp"> <div className='w-[461px] min-h-[46px] rounded-[8px] bg-gradient-to-l from-[#00B0BA] via-[black] to-[#007B82] flex justify-center items-center text-[white] font-bold text-[16px] leading-[35px] text-center cursor-pointer'>Send OTP</div></a>
